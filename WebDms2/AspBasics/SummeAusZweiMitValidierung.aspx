<%@ Page Title="" Language="C#" MasterPageFile="~/DMSMaster.Master" AutoEventWireup="true"
    CodeBehind="SummeAusZweiMitValidierung.aspx.cs" Inherits="WebDms2.AspBasics.SummeAusZweiMitValidierung"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table ID="tabRechnerLayout" runat="server" SkinID="tabSkin2">
        <asp:TableRow ID="TableRow1" runat="server">
            ...
            <asp:TableCell ID="tabCellVldA" runat="server" Width="10px" BackColor="Gray">
                ...
                <asp:RangeValidator ID="rngVldTbxA" runat="server" ErrorMessage="In A wurde keine gültige Zahl eingegeben"
                    Type="Double" ControlToValidate="tbxA" MinimumValue="-100000"
                    MaximumValue="100000" ForeColor="Red">*</asp:RangeValidator>
            </asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow2" runat="server">
            <asp:TableCell ID="TableCell3" runat="server" SkinID="tabCellSkin2_1">B =</asp:TableCell><asp:TableCell ID="TableCell4" runat="server" BackColor="Gray">
                ...
                <asp:CompareValidator ID="cmpVldB" runat="server" Type="Double" Operator="DataTypeCheck" ControlToValidate="tbxB"  ErrorMessage="In B wurde keine gültige Zahl eingegeben">*</asp:CompareValidator>
