<%@ Page Title="" Language="C#" MasterPageFile="~/DMSMaster.Master" AutoEventWireup="true"
    CodeBehind="HtmlControls.aspx.cs" Inherits="WebDms2.AspBasics.HtmlControls" EnableTheming="true" Theme="Design1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="Table1" style="width: 504px; height: 399px" cellspacing="1" cellpadding="1"
        ...
        <tr>
            <td style="width: 133px">
                Reiner HTML- Button mit Javascript- Eventhandler
            </td>
            <td style="width: 253px">
                <input onclick="javascript: alert('Hallo');" type="button" value="Html-Button" />
            </td>
        ...
        <tr>
            ...
            <td style="width: 253px">
                <asp:Button ID="Button1" runat="server" Text="WebCtrl- Button"></asp:Button>
            </td>
