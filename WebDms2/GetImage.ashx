...
public class GetImage : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {        
        try
        {
            ...
            SqlConnectionStringBuilder connBld = new SqlConnectionStringBuilder(System.Configuration.ConfigurationManager.ConnectionStrings["SqlFileFeaturesConnString"].ConnectionString);
